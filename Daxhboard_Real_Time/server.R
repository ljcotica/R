# Faz o resumo (consolidação) das informações coletadas no global.R
# Diz onde serão gravadas as informações

function(input, output, session) {
  
  # pkgStream é um objeto que representa o fluxo de Download de novos dados de pacotes; 
  # Retorna o número de novos downloads desde a última atualização.
